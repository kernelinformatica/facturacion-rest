...
public class GrabaOrdenesDePagoRest {
    ...
    public Response setComprobante(
        ...
        try {
            ...
            // el usuario no es necesario porque lo busco por el token de sesioon
            ...
            if (idNumero != null) {
                ...
                if (ordenPagoCabecera) {
                    //ordenPagosCab.setIdOPCab(cteNumerador);
                    ...
                    ordenPagosCab.setIdSisTipoOperacion(null);
            ...
            if (ordenPagoDetalle) {
                ...
                for (JsonElement j : grillaComprobantes) {
                    ...
                    ordenesPagosDetalle.setIdFactCab(idFactCab);
            ...
            if (ordenPagoFormaPago && grillaFormaPago != null) {
                ...
                for (JsonElement je : grillaFormaPago) {
                    ...
                    String detalle = (String) Utils.getKeyFromJsonObject("String", je.getAsJsonObject(), "String");
                    //Pregunto si son nulos 
                    if (idOPcab == null || importe == null || idFormaPago == null || fechaAcreditacion == null || numeroComp == null || detalle == null) {
                    ...
                    opFpago.setDetalle(opFpago.getDetalle());
             ...
             //Empiezo con la grilla de SubTotales para grabar ordenPagoPie
                if (ordenPagoPie) {
                    for (JsonElement je : grillaSubTotales) {
                        Integer idImpuesto = (Integer) Utils.getKeyFromJsonObject("importe", je.getAsJsonObject(), "I");
                        ...
                        if (importeImpuesto.equals(0)) {
                         ...
                         if (alicuota.equals(0)) {
                            System.out.println("Error al llevar la alicuota, venia en 0, " + detalle);
                        }
                        //Pregunto por los que no pueden ser Null
                        if (idOPCab == null || detalle == null || idImpuesto == null || alicuota == null || numeroRetencion == null) {
